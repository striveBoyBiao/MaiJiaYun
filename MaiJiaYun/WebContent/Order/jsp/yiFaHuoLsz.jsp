		...
		<thead class=" table-bordered">
			<tr>
							...
							<ul class="dropdown-menu" role="menu"
								...
								<li role="presentation"><a role="menuitem" tabindex="-1"
									href="javascript:void(0);"><span style="color: red"
										class="glyphicon glyphicon-flag"><span class="hide">红</span></span></a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1"
									href="javascript:void(0);"><span style="color: #F90"
										class="glyphicon glyphicon-flag"><span class="hide">黄</span></span></a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1"
									href="javascript:void(0);"><span style="color: green"
										class="glyphicon glyphicon-flag"><span class="hide">绿</span></span></a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1"
									href="javascript:void(0);"><span style="color: blue"
										class="glyphicon glyphicon-flag"><span class="hide">蓝</span></span></a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1"
									href="javascript:void(0);"><span style="color: violet"
										class="glyphicon glyphicon-flag"><span class="hide">紫</span></span></a></li>
							</ul>
						</div>
					</div>
				</th>
				...
				<th colname="splitMergeStatus" class="select" title="提醒">
					<div class="dropdown">
						...
						<ul class="dropdown-menu" role="menu"
							...
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="javascript:void(0);"><span
									class="glyphicon glyphicon-lock" style="color: #F90"></span>锁单</a></li>
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu" role="menu"
							...
							<li role="presentation" class="sort" type="up"><a
								role="menuitem" tabindex="-1" href="javascript:void(0);"><span
				...
				<th colname="eShopName" class="select" title="店铺名">
					<div class="dropdown">
						...
						<ul class="dropdown-menu" role="menu"
							...
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="javascript:void(0);">卖家云分销</a></li>
				...
				<th colname="isExpressSheetPrinted" class="select" title="打印快递单">
					<div class="dropdown">
						<button class="btn dropdown-toggle fb"
							style="padding: 0; box-shadow: none; background: none"
							type="button" id="dropdownMenu1" data-toggle="dropdown">
							<span class="title">打印快递单</span> <span class="caret"></span>
						</button>
						<ul class="dropdown-menu" role="menu"
							aria-labelledby="dropdownMenu1">
							...
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="javascript:void(0);">已打印</a></li>



							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="javascript:void(0);">未打印</a></li>
				...
				<th colname="isDeliverySheetPrinted" class="select" title="打印发货单">
					<div class="dropdown">
						<button class="btn dropdown-toggle fb"
							style="padding: 0; box-shadow: none; background: none"
							type="button" id="dropdownMenu1" data-toggle="dropdown">
							<span class="title">打印发货单</span> <span class="caret"></span>
						</button>
						<ul class="dropdown-menu" role="menu"
							aria-labelledby="dropdownMenu1">
				...
				<th colname="buyerMemo" class="select" title="买家备注">
					<div class="dropdown">
						...
						<ul class="dropdown-menu" role="menu"
							...
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="javascript:void(0);">有买家备注</a></li>



							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="javascript:void(0);">无买家备注</a></li>
				...
				<th colname="sellerMemo" class="select" title="卖家备注">
					<div class="dropdown">
						...
						<ul class="dropdown-menu" role="menu"
							...
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="javascript:void(0);">有卖家备注</a></li>



							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="javascript:void(0);">无卖家备注</a></li>
				...
				<th style="border-right: none"><a data-toggle="modal"
					data-target="#tableModal" style="cursor: pointer;" id="theadSet">列设置</a>
				</th>
			</tr>
		</thead>
