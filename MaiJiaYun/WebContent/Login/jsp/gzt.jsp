...
<body>
	...
	<div class="container" id="container">
		...
		<div class="contentbox" id="contentbox" style="display: block; background: rgb(241, 241, 241);">
						...
						<div class="row white p15 mt20 tc">
							...
							<div class="row mb10" id="fxsgl">
								<a href="http://maijiayun.cn/fxsgl.html" target="_blank"> <img
									src="${pageContext.request.contextPath}/Login/img/fxsgl.png">
								</a>
							</div>

							<div class="row mb10" id="mjyerp">
								<a href="http://maijiayun.cn/mjyerp.html" target="_blank"> <img
									src="${pageContext.request.contextPath}/Login/img/mjyerp.png">
								</a>
							</div>
						</div>
						...
						<div class="row white mt20 tc">
							<div class="linkBlock">
								...
								<img width="165" height="206"
									src="${pageContext.request.contextPath}/Login/img/qrcode.jpg">
							</div>
						</div>
						<!--<div class="row white mt20 tc">
  <div class="linkBlock">
					...
					<div class="row white p15">
						<div class="media">
							<a class="s-avatar_big pull-left"
								...
								src="${pageContext.request.contextPath}/Login/img/admin_logo.png"
								width="80" height="80">
							</a>
							<div class="media-body">
								<div class="media-heading f20 companyName">
									<a style="text-decoration: none;" class="c0"
										href="http://maijiayun.cn/page.html#/fxs/homepage/70243"
										target="_blank">${userInfoVO.bossPO.bossCompanyName}</a>
								</div>
									...
									<ul class="media-list dicussUl"
										...
										<li class="media m-userinfo discuss"
											...
											href="javascript:void(0);" class="s-avatar_normal pull-left">
												...
												src="${pageContext.request.contextPath}/Login/img/portrait.png">
								...
								<div class="row" style="overflow: hidden;">
									...
									<ul class="media-list dicussUl"
										...
										<li class="media m-userinfo discuss"
											...
											href="javascript:void(0);" class="s-avatar_normal pull-left">
												<img width="60" height="60" class="media-object"
												src="${pageContext.request.contextPath}/Login/img/1479136338127QQ图片20161105233818.jpg">
												<span class="s-round-mask"></span>
										</a>
											<div class="media-body f14" style="overflow: hidden;">
												<h5 class="media-heading fn c9 lh30 dropdown">
								...
								<div class="row" style="overflow: hidden;">
									...
									<ul class="media-list dicussUl"
										...
										<li class="media m-userinfo discuss"
											...
											href="javascript:void(0);" class="s-avatar_normal pull-left">
												<img width="60" height="60" class="media-object"
												src="${pageContext.request.contextPath}/Login/img/1479460859342侠客全球行LOGO.jpg">
												<span class="s-round-mask"></span>
										</a>
											<div class="media-body f14" style="overflow: hidden;">
												<h5 class="media-heading fn c9 lh30 dropdown">
								...
								<div class="row" style="overflow: hidden;">
									...
									<ul class="media-list dicussUl"
										...
										<li class="media m-userinfo discuss"
											...
											href="javascript:void(0);" class="s-avatar_normal pull-left">
												<img width="60" height="60" class="media-object"
												src="${pageContext.request.contextPath}/Login/img/1479387018560IMG_20141105_170526_副本.jpg">
												<span class="s-round-mask"></span>
										</a>
											<div class="media-body f14" style="overflow: hidden;">
												<h5 class="media-heading fn c9 lh30 dropdown">
				...
				<div class="col-lg-3">
					...
					<div class="row white p15">
						<div class="media m-userinfo">
							<a href="javascript:void(0);" data-toggle="modal"
								data-target="#edit_accountModal"
								class="s-avatar_big pull-left mr10"> <span
								class="s-edit-mask">个人信息</span> <img id="userAvatorUrl"
								src="${userInfoVO.userPO.userImgPath}"
								width="80" height="80"> <span
								class="s-round-mask editUserInfo"></span>
							</a>
							<div class="media-body">
								<div style="overflow: hidden;" class="media-heading f20">${userInfoVO.userPO.userNickname}</div>
								<div class="row mt20 mb5">
									<div class="f12 c6">
										<a href="javascript:void(0);" class="editUserInfo"
											data-toggle="modal" data-target="#edit_accountModal">
											修改个人信息</a>
									</div>
								</div>
							</div>
						...
						<script>
							$("#setTenantryFunction").on('click', function() {
								window.location.href = "<%=request.getContextPath()%>/servlet/setSystem";
							});
						</script>
					</div>
					<!--1 end-->
					...
					<div class="row white mt20">
						<a href="http://maijiayun.cn/#" data-toggle="modal"
							...
							width="263" height="190"
							src="${pageContext.request.contextPath}/Login/img/yaoqing2.jpg"></a>
					</div>
								...
								<ul class="media-list">
									<div class="p15">
										<a href="http://maijiayun.cn/page.html#gys/homepage/1039"
											...
											<div class="">
												<img
													src="${pageContext.request.contextPath}/Login/img/tuijian02.jpg"
