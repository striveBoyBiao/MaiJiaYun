<%@page import="mjy.caigou.vo.StuEntity"%>

<%@page import="java.util.List"%>
<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<!DOCTYPE html>
<!-- saved from url=(0089)http://maijiayun.cn/cg/caigoudan/importCaigouSuccess/caff56cb-30d2-4f4d-b586-4d006e512533 -->
...
<div class="collapse navbar-collapse navbar-default navbar-titletab">
	<div class="navbar-header">
		<a class="navbar-brand ml20" href="http://maijiayun.cn/#">采购单预览</a>
	</div>
</div>
<!--titletab end-->
<!--panel star-->
...
<div class="prl10auto">
			...
			<h5>
				<form class="form-inline" role="form" >
					...
					<div class="form-group pr20">
						<div class="btn-group select necessary" name="srcWarehouseId"><%=request.getAttribute("supplierName") %></div>
					</div>
					<div class="form-group pr10">调入仓库：</div>
					<div class="form-group pr20">
						<div class="btn-group select necessary" name="dstWarehouseId"><%=request.getAttribute("wareHouseName") %></div>
					</div>
				</form>
			</h5>
		</div>
	...
	<!-- Table -->
	<div id="skuPanel">
		<div style="margin-bottom:20px;" class="well well-lg tc">
			<table class="table table-striped table-hover" style="margin-bottom:20px;">
				...
				<tbody>
					...
					<% //List<PurchaseGoodVO> purchaseGoodVO=(PurchaseGoodVO)request.getAttribute("purchaseGoodVO");
							List<StuEntity> stuEntity_2=(List<StuEntity>)request.getAttribute("stuEntity_2");
							for(StuEntity stuEntity:stuEntity_2){
							%> 
					<tr>
						<td class="fb"><%=stuEntity.getSku()%></td>
						<td><%=stuEntity.getPurchaseNumber()%></td>
						<td><%=stuEntity.getPurchasePrice()%></td>
						<td><%=stuEntity.getRemark_2()%></td>
					</tr>
					<%} %>
				</tbody>
			</table>
	...
	<!--table end-->
				...
				<button class="btn btn-primary mr5 save" type="submit" onclick="getDaoRu()">导入</button>
				<button class="btn btn-default cancel" id="btnReturn" type="button">取消</button>
			</div>
         <!--分页 star-->
             <div class="row" style="margin:0">
              <div style=" float:right;">
			<div style="width: 150px; float: left;">
				<ul class="pagination" id="pageSize">
					<li class="dropup">
						<div class="lh30 left">每页显示</div>
						<div class="btn-group" style="margin: 0 5px;">
							<button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button" id="pageSizeSelect">10<span class="caret"></span></button>
							<div class="lh30 left" style="margin-left: 5px;">个</div>
							<ul role="menu" class="dropdown-menu">
								<li pagesize="10"><a href="javascript: void(0);">10</a></li>
								<li pagesize="20"><a href="javascript: void(0);">20</a></li>
								<li pagesize="50"><a href="javascript: void(0);">50</a></li>
							</ul>
						</div>
					</li>
				</ul>
				...
				<ul class="pagination" id="pageNo">
					...
					<li class="fb fmsun" pageno="0"><a href="javascript: void(0);">&lt;</a></li>
					
						<li class="active" pageno="1"><a href="javascript: void(0);">1</a></li>
					
					
					<li class="fb fmsun" pageno="2"><a href="javascript: void(0);">&gt;</a></li>
				</ul>
                </div>
              </div>
             </div>
  ...
  <div id="spinner" style="display:none;">
    <div class="modal fade" aria-hidden="false" role="dialog" tabindex="-1" style="display:block;">
      <div class="modal-dialog tc" style="margin-top:300px;">
        <img src="./caff56cb-30d2-4f4d-b586-4d006e512533_files/loading3.gif">
      </div>
    </div>
...
<div class="say w-xxl bg-white md-whiteframe-z2 ng-scope">
 ...
 <!--  <div aria-hidden="true" aria-labelledby="edit_accountModalLabel" role="dialog" tabindex="-1" id="edit_accountModal" class="modal fade" style="display: none;"></div> -->
  <div id="modal"></div>
</div>
<!--代码结束--></body></html>