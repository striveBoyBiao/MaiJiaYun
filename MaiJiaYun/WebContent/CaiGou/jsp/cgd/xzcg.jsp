...
<body class="" style="padding-right: 0px;">
    ...
    <div class="navbar-header">
      <a href="http://maijiayun.cn/#" class="navbar-brand ml20">新增采购单</a>
    </div>
    ...
    <!-- <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" id="xuzhegongyinshang">
      ...
      <span class="caret"></span>
    									...
    									<button type="button"
											...
											<span class="filter-option pull-left" id="xuzhegongyinshang">请选择</span>&nbsp;<span
												class="caret"></span></span><span class="text" style="display: none;" id="qingxuanzhe_1"></span>
										</button>
										...
										<!-- <button type="button"
											...
											<ul class="dropdown-menu inner selectpicker" role="menu"
												...
												<li rel="0" class="selected"><a tabindex="0" class=""
													style=""><span class="text">请选择</span></a></li>
								...
								<div class="form-group pr20">
									...
									<div class="btn-group bootstrap-select" style="width: 88px;">
										<button type="button"
											class="btn dropdown-toggle selectpicker btn-default"
											data-toggle="dropdown" title="请选择" ;">
											<span class="filter-option pull-left" id="rukucangku">请选择</span>&nbsp;<span
												class="caret"></span><span class="text" style="display: none;" id="qingxuanzhe_2"></span>
										</button>
 ...
 -->
												...
												<div class="tl lh30 scrollspy-example"
													...
													<table class="table table-striped table-hover"
														...
														<tbody style="font-weight: normal">
															...
															<%	
														 int k=0;
														List<GoodsPO> listGoodsPO=(List<GoodsPO>)request.getAttribute("listGoodsPO");
			...
			<div class="panel prl10auto" style="padding: 20px 10px ;margin: 10px 10px 0px 10px;" id="caigou">
				<!-- Table -->
				<div id="skuPanel">
					 <div class="well well-lg tc" style="margin-bottom: 20px"
						id="caigou" >
						<table class="table "
								style="margin-bottom: 0; text-align: center;" id="addgood">采购商品</table>
								</div> 
				...
				<div style="padding: 20px 10px 40px 10px">
					<button class="btn btn-primary mr5 save" type="button" onclick="addPurchaseGood_2()" >
						保存
