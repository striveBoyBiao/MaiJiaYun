		...
		<div style="background: #f1f1f1">
										...
										$
												.each(
														...
														function(index, element) {
															...
															//注意此处的value值需要动态改变
															optStr += "<option value="+element.goodGroupId+">"
				...
				<div class="panel prl10auto" id="goodsPicPanel">
					...
					<div class="row mt15 mb20">
						<div class="row">
							...
							<!-- <div style="float: left;"><img style="height: 100px;width: 100px; display: none;"  src="" id="goodPicture"/> <a href="javascript:void(0);"><div class="carousel-caption deleteGoodsPic">删除</div></a></div> -->
							<!--添加图片 star-->
							<div class="col-md-2 mb10" id="addGoodsPicDiv" onclick="qingkong()">
									...
									<div class="tab-pane active" id="one">
										<div class="mt15">
											<input id="picUrl1" type="text" name="picUrl"
												...
												style="width: 455px" onchange="changetext1()">
										</div>
									</div>
										...
										<form id="goodsPicForm" method="POST"
											...
											<div class="mt15">
												<input id="picUrl2" type="file" name="picUrl"
													...
													style="width: 455px" onchange="changetext()">
											</div>
						...
						<div class="row mt15" style="padding-bottom: 20px;">
										...
										<td class="fb">
											<div class="form-group">
												<input type="text" id="skucode"
													class="form-control skuPanel" name="code" value="-1">
											</div>
										</td>
										<td>
											<div class="form-group">
												<input type="text" id="goodprice"
													class="form-control float skuPanel" name="price" value="0">
											</div>
										</td>
										<td>
											<div class="form-group">
												<input type="text" id="goodweight"
													class="form-control float skuPanel" name="weight" value="0">
											</div>
										</td>
										<td>
											<div class="form-group">
							...
							<script>
								...
								function huohao() {
									...
									document.getElementById("aa").value = document
											.getElementById("code").value;
									document.getElementById("dd").value = document
											.getElementById("title").value;
									document.getElementById("bb").value = document
			...
			<script>
				...
				function showModel() {
					...
					var actEle = document.getElementsByClassName("active")[0]
							.getElementsByTagName("a")[0].getAttribute(
							"data-target").substring(1);

					var message = document.getElementById(actEle)
						...
						$
								.ajax({
									...
									success : function(data) {
										...
										$("#goodpicturediv").css('display',
												'block');
										$("#goodPicture").css('display',
												'block');
										$("#goodPicture").attr('src',
												goodPicturePath);
