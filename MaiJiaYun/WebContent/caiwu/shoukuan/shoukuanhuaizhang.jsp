<%@page import="mjy.caiwu.shoukuan.beans.CwPageInfo"%>
<%@page import="mjy.caiwu.shoukuan.beans.CwShouKuanVO"%>
			...
			<div class="collapse navbar-collapse navbar-default navbar-titletab"
				...
				<ul class="nav nav-tabs f14 fb">
					<li id="li-shoukuan" class="ml20 tab "><a data-toggle="tab"
						...
						class="c6" onclick="clickShou()">应收款</a></li>
					<li id="li-yishou" class="tab"><a data-toggle="tab"
						href="${pageContext.request.contextPath}/servlet/cw/yiShou"
						class="c6">已收款</a></li>
					<li id="li-shoukuanhuaizhang" class="tab active"><a data-toggle="tab"
						href="${pageContext.request.contextPath}/servlet/cw/shouKuanHuaiZhang"
						class="">坏账</a></li>
					<li class="pull-right mr10" id="li-query"
						style="padding-top: 12px;">
						<form calss="form-inline" action="/MaiJiaYun/servlet/cw/shouKuanHuaiZhang" role="form" method="post">
						<div class="w340">
			...
			<div class="prl10auto" id="panel">
				...
				<div class="panel">
					...
					<jsp:include page="pagination.jsp">
					  <jsp:param value="${pageContext.request.contextPath}/servlet/cw/shouKuanHuaiZhang" name="url"/>
					</jsp:include>
				</div>
			</div>
